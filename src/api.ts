...
// 'https://api.open-meteo.com/v1/forecast?latitude=52.43&longitude=30.98&hourly=temperature_2m,precipitation_probability,surface_pressure,visibility,windspeed_10m,winddirection_10m&windspeed_unit=ms&timezone=auto&past_days=1'
